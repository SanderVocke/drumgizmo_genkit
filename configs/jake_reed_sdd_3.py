...
def genkit_config() -> GenKitConfig:
    return {
        ...
        'instrument_features': [
            InstrumentChokesOthers(instrument='TIGHT_HH',       chokes=['FAT_HH',   'CHUNKY_HH', "SIZZLE_HH",      "LONG_SIZZLE_HH"]),
            InstrumentChokesOthers(instrument='FAT_HH',         chokes=['TIGHT_HH', 'CHUNKY_HH', "SIZZLE_HH",      "LONG_SIZZLE_HH"]),
            InstrumentChokesOthers(instrument='CHUNKY_HH',      chokes=['FAT_HH',   'TIGHT_HH',  "SIZZLE_HH",      "LONG_SIZZLE_HH"]),
            InstrumentChokesOthers(instrument='SIZZLE_HH',      chokes=['FAT_HH',   'TIGHT_HH',  "LONG_SIZZLE_HH", "CHUNKY_HH"]),
            InstrumentChokesOthers(instrument="LONG_SIZZLE_HH", chokes=['FAT_HH',   'TIGHT_HH',  "SIZZLE_HH",      "CHUNKY_HH"]),
            ContinuousHihat(
                hihat_steps=[
                    ContinuousHihatEntry(instrument='TIGHT_HH',       openness=0.0),
                    ContinuousHihatEntry(instrument='FAT_HH',         openness=0.25),
                    ContinuousHihatEntry(instrument='CHUNKY_HH',      openness=0.5),
                    ContinuousHihatEntry(instrument='SIZZLE_HH',      openness=0.75),
                    ContinuousHihatEntry(instrument='LONG_SIZZLE_HH', openness=1.0),
                ],
                combined_instrument_name='HH_CONTINUOUS',
            ),
            InstrumentChokesOthers(instrument="HH_CONTINUOUS", chokes=['HH_CONTINUOUS']),
        ],
    }